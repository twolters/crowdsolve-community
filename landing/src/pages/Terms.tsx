...
export default function Terms() {
  return (
    <LegalPageLayout
      ...
      pageTitle="Terms of Service | CrowdSolve"
      description="Terms governing subscriptions, free trials, account usage, AI tools, cancellations, and participation in the CrowdSolve founder community."
      effectiveDate="September 15, 2026"
    >
      <p className="text-slate-600 leading-relaxed mb-6">
        Welcome to CrowdSolve. These Terms of Service ("Terms") govern your access to and
        use of the CrowdSolve website, community, curriculum, events, AI tools, and related
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold text-brand-900 mb-4">1. What CrowdSolve Provides</h2>
        ...
        <ul className="list-disc pl-6 space-y-2 text-slate-600 leading-relaxed mb-4">
          ...
          <li>
            Other resources, programs, and services that CrowdSolve may introduce from time
            to time
          </li>
        </ul>
        <p className="text-slate-600 leading-relaxed">
          CrowdSolve provides education, tools, feedback, and community support. We do not
          guarantee that participation will result in funding, revenue, customers,
      ...
      <section className="mb-10">
        ...
        <p className="text-slate-600 leading-relaxed mb-4">
          ...
          for activity occurring through your account.
        </p>
        <p className="text-slate-600 leading-relaxed">
          You may not share your account credentials with another person or allow another
          person to use CrowdSolve through your paid account unless CrowdSolve has expressly
          permitted it.
        </p>
      </section>

      <section className="mb-10">
        <h2 className="text-2xl font-bold text-brand-900 mb-4">3. Seven-Day Free Trial</h2>
        <p className="text-slate-600 leading-relaxed mb-4">
        ...
        <p className="text-slate-600 leading-relaxed mb-4">
          ...
          before the end of the 7-day trial, your account will automatically convert to a
          paid monthly subscription at the price shown when you sign up.
        </p>
        <p className="text-slate-600 leading-relaxed mb-4">
          By beginning a free trial and providing a payment method, you authorize CrowdSolve
          and its payment provider to charge that payment method when the trial ends and on
          a recurring monthly basis thereafter until you cancel or pause your subscription.
        </p>
        <p className="text-slate-600 leading-relaxed">
      ...
      <section className="mb-10">
        ...
        <p className="text-slate-600 leading-relaxed mb-4">
          After the free trial, CrowdSolve subscriptions are billed monthly in advance at
          the price presented to you when you subscribe.
        </p>
        <p className="text-slate-600 leading-relaxed mb-4">
          Your subscription will automatically renew each month unless you cancel or pause
          it.
        </p>
        <p className="text-slate-600 leading-relaxed mb-4">
          CrowdSolve may change subscription pricing in the future. If we do, existing
          subscribers will receive reasonable advance notice before the new price applies to
          them.
        </p>
        <p className="text-slate-600 leading-relaxed">
          Unless required by law or otherwise agreed by CrowdSolve, subscription payments
      ...
      <section className="mb-10">
        ...
        <p className="text-slate-600 leading-relaxed mb-4">
          Cancellation does not require navigating an automated cancellation process. Simply
          send us written notice by:
        </p>
        <ul className="list-disc pl-6 space-y-2 text-slate-600 leading-relaxed mb-4">
          <li>
            Emailing <EmailLink email={EMAIL} />, or
          </li>
          <li>
            Sending Tim Wolters a direct message through the CrowdSolve community or another
            communication channel you normally use with CrowdSolve.
          </li>
        </ul>
        <p className="text-slate-600 leading-relaxed mb-4">
        ...
        <p className="text-slate-600 leading-relaxed mb-4">
          Because some information may temporarily remain in routine system backups or may
          need to be retained for accounting, legal, fraud-prevention, or regulatory
          purposes, deletion from every backup system may not occur immediately. Any
          retained information will no longer be used to provide your CrowdSolve account and
          will be deleted or anonymized in accordance with our normal data-retention
          practices.
        </p>
        <p className="text-slate-600 leading-relaxed">
          If you think you were charged after properly cancelling, contact{' '}
          <EmailLink email={EMAIL} /> and we will investigate the issue.
        </p>
      </section>
      ...
      <section className="mb-10">
        ...
        <p className="text-slate-600 leading-relaxed mb-4">
          To pause your subscription, send written notice to <EmailLink email={EMAIL} /> or
          send Tim Wolters a direct message.
        </p>
        ...
        <ul className="list-disc pl-6 space-y-2 text-slate-600 leading-relaxed mb-4">
          ...
          <li>
            Your account, startup profile, curriculum progress, and other information are
            maintained within CrowdSolve.
          </li>
          <li>
          ...
          <li>
            You may{' '}
            <strong>
              not participate in subscriber-only working sessions, coaching sessions, or
              similar programming
            </strong>
            .
          </li>
          <li>
            You may{' '}
            <strong>
              not receive individualized feedback, analysis, or assistance from Marvin or
              other CrowdSolve AI tools regarding your startup
            </strong>
            .
          </li>
        </ul>
        <p className="text-slate-600 leading-relaxed mb-4">
          ...
          normal subscription billing and full member access will resume when your account
          is reactivated.
        </p>
        <p className="text-slate-600 leading-relaxed">
          CrowdSolve may periodically contact paused members to determine whether they would
          like to reactivate or cancel their account.
        </p>
      </section>
      ...
      <section className="mb-10">
        ...
        <p className="text-slate-600 leading-relaxed mb-4">
          By submitting information to CrowdSolve, you give us a limited license to store,
          process, analyze, display, and otherwise use that information as reasonably
          necessary to operate the Service and provide the features you request.
        </p>
        <p className="text-slate-600 leading-relaxed mb-4">
        ...
        <p className="text-slate-600 leading-relaxed">
          We may use aggregated or de-identified information to understand how founders use
          CrowdSolve, improve the Service, and evaluate program effectiveness, provided that
          this information does not reasonably identify you or disclose your confidential
          startup information.
        </p>
      </section>
      ...
      <section className="mb-10">
        ...
        <p className="text-slate-600 leading-relaxed mb-4">
          CrowdSolve includes community features that encourage founders to communicate with
          one another.
        </p>
        <p className="text-slate-600 leading-relaxed mb-4">
          Information that you voluntarily post in community discussions, events, comments,
          profiles, or other shared areas may be visible to other CrowdSolve members.
        </p>
        <p className="text-slate-600 leading-relaxed mb-4">
          You should not post trade secrets, confidential information, personally sensitive
          information, or third-party information in a shared area unless you are
          comfortable sharing it with the members who have access to that area.
        </p>
        <p className="text-slate-600 leading-relaxed">
          While we expect CrowdSolve members to respect one another and the confidentiality
          of fellow founders, CrowdSolve cannot guarantee that another community member will
          keep information confidential unless a separate confidentiality agreement applies.
        </p>
      </section>
      ...
      <section className="mb-10">
        ...
        <ul className="list-disc pl-6 space-y-2 text-slate-600 leading-relaxed mb-4">
          ...
          <li>
            Make recommendations that are inappropriate for your particular circumstances.
          </li>
        ...
        <p className="text-slate-600 leading-relaxed mb-4">
          Marvin and other CrowdSolve AI tools are intended to assist your thinking and are{' '}
          <strong>
            not a substitute for professional legal, accounting, tax, investment, financial,
      ...
      <section className="mb-10">
        ...
        <p className="text-slate-600 leading-relaxed mb-4">
          Mentors, speakers, advisors, community members, and other participants may have
          different perspectives, and CrowdSolve does not guarantee the accuracy or
      ...
      <section className="mb-10">
        ...
        <ul className="list-disc pl-6 space-y-2 text-slate-600 leading-relaxed mb-4">
          ...
          <li>
            Use another founder's confidential information or intellectual property without
            permission.
          </li>
          <li>
      ...
      <section className="mb-10">
        ...
        <p className="text-slate-600 leading-relaxed mb-4">
          ...
          curriculum, software, designs, branding, instructional materials, AI prompts and
          workflows, videos, written content, tools, and other intellectual property used to
          provide the Service.
        </p>
        <p className="text-slate-600 leading-relaxed mb-4">
          Your subscription gives you a limited, personal, non-exclusive right to use these
          materials for your own startup development.
        </p>
        <p className="text-slate-600 leading-relaxed">
          Unless CrowdSolve gives you permission, you may not reproduce, resell, sublicense,
          publish, create a competing service from, or commercially distribute CrowdSolve
          materials.
        </p>
      </section>
      ...
      <section className="mb-10">
        ...
        <p className="text-slate-600 leading-relaxed mb-4">
          CrowdSolve may rely on third-party platforms and service providers for community
          hosting, payments, video conferencing, artificial intelligence, email, analytics,
        ...
        <p className="text-slate-600 leading-relaxed">
          CrowdSolve is not responsible for outages, changes, security incidents, or other
          actions of third-party providers that are outside CrowdSolve's reasonable control.
        </p>
      </section>
      ...
      <section className="mb-10">
        ...
        <p className="text-slate-600 leading-relaxed mb-4">
          ...
          discontinue features, curriculum, programming, AI capabilities, events, or other
        ...
        <p className="text-slate-600 leading-relaxed mb-4">
          If we make a material change that significantly affects existing subscribers, we
          will provide reasonable notice through email, the CrowdSolve community, or the
          Service.
        </p>
        <p className="text-slate-600 leading-relaxed">
      ...
      <section className="mb-10">
        ...
        <p className="text-slate-600 leading-relaxed">
          Entrepreneurship involves substantial uncertainty and risk. You are responsible
          for how you apply what you learn through CrowdSolve.
        </p>
      </section>
      ...
      <section className="mb-10">
        ...
        <p className="text-slate-600 leading-relaxed mb-4">
          To the fullest extent permitted by applicable law, CrowdSolve and its officers,
          employees, contractors, mentors, advisors, and affiliates will not be liable for
          indirect, incidental, special, consequential, or punitive damages arising from
          your use of the Service or decisions you make based on information obtained
          through CrowdSolve.
        </p>
        <p className="text-slate-600 leading-relaxed mb-4">
          To the fullest extent permitted by law, CrowdSolve's total liability for any claim
          relating to the Service will not exceed the amount you paid CrowdSolve during the
      ...
      <section className="mb-10">
        ...
        <p className="text-slate-600 leading-relaxed mb-4">
          CrowdSolve may suspend or terminate an account for material violations of these
          Terms, misuse of the Service, abuse of other community members, nonpayment,
          fraudulent activity, or conduct that creates a significant risk to CrowdSolve or
          its community.
        </p>
        <p className="text-slate-600 leading-relaxed">
      ...
      <section className="mb-10">
        ...
        <p className="text-slate-600 leading-relaxed mb-4">
          These Terms will be governed by the laws of the <strong>State of Colorado</strong>,
      ...
      <section className="mb-10">
        ...
        <p className="text-slate-600 leading-relaxed">
          These Terms, together with any applicable program-specific terms, payment terms,
          or{' '}
          <a href="/privacy" className="text-brand-600 underline hover:text-brand-700">
            Privacy Policy
          </a>{' '}
          made available by CrowdSolve, constitute the agreement between you and CrowdSolve
      ...
      <section>
        ...
        <p className="text-slate-600 leading-relaxed mb-4">
          Questions, cancellation requests, pause requests, or concerns about these Terms
          can be sent to:
        </p>
        <p className="text-slate-600 leading-relaxed">
